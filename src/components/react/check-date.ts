    ...
    let state = {
        ...
        statistics: {
          "optional": {
            ...
            percentAnswerForDay: ((data?.optional?.percentAnswerRightSprint + data?.optional?.percentRightAudioCall) /2) || data?.optional?.percentAnswerRightSprint || data?.optional?.percentRightAudioCall || 0,
